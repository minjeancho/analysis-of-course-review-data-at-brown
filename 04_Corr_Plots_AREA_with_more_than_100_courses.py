...
def show_AREA_correaltion_plot(x, y, x_name, y_name, weights, save_file=1, prefix="XXXX"):
    # REFERENCE: matplotlib example (modified)
    ...
    ax_scatter.scatter(x,y,s=rel_weights*len(weights)*30,
    ...
    #plt.tight_layout()
    if save_file == 1:
        file_name = "FIG_scatter_" + area + "_" + x_name + "_" + y_name + ".png"
...
for area in areas:
    ...
    df = score_array_to_dataframe(score_array)
    print("#######################################")
    print("#   ", area)
    print("#######################################")
    print("n_courses:", df.shape[0], "(raw)")
    df = df.dropna(axis=0)
    print("n_courses:", df.shape[0], "(valid)")
    if df.shape[0] >= 100:    
        # ==================================
        x_name = "minhours"
        y_name = "grade"
        ...
        df = df.dropna(axis=0)
        print("n_courses:", df.shape[0], "(outlier_removed)")    
        ...
        print("===============================================")
        print()
        show_AREA_correaltion_plot(x, y, x_name, y_name, wt, save_file=1, prefix=area)
        show_AREA_correaltion_plot(z, x, z_name, x_name, wt, save_file=1, prefix=area)
        show_AREA_correaltion_plot(z, y, z_name, y_name, wt, save_file=1, prefix=area)
        ...
        print("===============================================")
        print()
        #show_correaltion_plot(x, y, x_name, y_name, wt, save_file=0, prefix=area)
        #show_correaltion_plot(z, x, z_name, x_name, wt, save_file=0, prefix=area)
        #show_correaltion_plot(z, y, z_name, y_name, wt, save_file=0, prefix=area)
